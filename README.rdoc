...
3. Most of the code should be test-covered - try 100%
...
6. Using any open source libraries:
   ...
   B. Twitter bootstrap for look and feel.
...
9. As a user, I want to tweet a completed task
10. As a user, I want to attach files to a task
11. As a user, I want to get notified by email after a deadline exceeded.